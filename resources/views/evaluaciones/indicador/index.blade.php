      ...
      <div class="">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="x_panel">
              ...
              <div class="x_content">                  
                  <a href="{{ route('cargos.create') }}" class="btn btn-success" style="background-color: rgb(51, 204, 204)"><i class="fa fa-plus-circle"></i> Registrar Indicador</a>
              </div>
            </div>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <form class="row" method="POST" action="{{ route('cargos.destroy', ['id' => $pos->id]) }}" onsubmit = "return confirm('Eliminar Usuario?')">
                            ...
                            <a href="{{ route('cargos.edit', ['id' => $pos->id]) }}" class="btn btn-warning col-sm-3 col-xs-5 btn-margin btn-xs" style="margin-left: 5px; margin-right: 5px;">
                              Editar
                            </a>
