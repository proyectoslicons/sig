...
<body class="hold-transition login-page"  style="background-image: url('../img/fondo.jpg'); background-position: center center; background-attachment: fixed; background-size: cover;">
    ...
    <div id="app" v-cloak>
        ...
        <div class="login-box-body" style=" background: rgba(0,0,0,.4);">
        ...
        <form action="{{ url('/login') }}" method="post">
            ...
            <div class="row">
                ...
                <div class="col-xs-4">
                    <button type="submit" class="btn btn-primary btn-block btn-flat" style="width: 130%; margin-left: -25px; white-space:normal;"> {{ trans('adminlte_lang::message.buttonsign') }}</button>
                </div><!-- /.col -->
            </div>
        </form>        
